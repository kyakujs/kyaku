...
function ContextMenuSubContent({ ...props }: React.ComponentProps<typeof ContextMenuPopup>) {
  return <ContextMenuPopup data-slot="context-menu-sub-content" side="right" {...props} />;
}
