...
export function Header({ children }: PropsWithChildren) {
  return (
    <div>
      <header className="border-border flex h-10 items-center gap-2 border-b px-4">
        <Button
          variant="outline"
          size="xs"
      ...
      <div className="border-border flex h-10 w-full items-center gap-2 border-b px-4">
